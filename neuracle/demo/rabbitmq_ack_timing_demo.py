...
使用方式：
1. 先启动 RabbitMQ
2. 再启动 `python -m neuracle.main`
3. 最后运行 `python -m neuracle.demo.rabbitmq_ack_timing_demo`
"""
...
logger = logging.getLogger("neuracle.demo.rabbitmq_ack_timing_demo")
...
def main() -> None:
    ...
    logger.info(
        "请同时观察 main.py 日志中的 received / worker_started / worker_finished / ack_scheduled / ack_sent"
    )
