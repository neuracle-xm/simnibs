...
```bash
TRANSITION=$(node "C:/Users/50609/Documents/simnibs/.claude/get-shit-done/bin/gsd-tools.cjs" phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node "C:/Users/50609/Documents/simnibs/.claude/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
node "C:/Users/50609/Documents/simnibs/.claude/get-shit-done/bin/gsd-tools.cjs" config-set workflow._auto_chain_active false
```
