...
* Since SimNIBS version v4.6, CHARM uses per default a new segmentation atlas that includes subcutaneous fat for improved skull border segmentation. If you want to use the previous version of the segmentation atlas, use (option *--useatlasv1_0*)
